...
%
% 12 states version, works with PWC inputs reference trajectory generated in
% flatness/GeneratePWC_reference.m

classdef MPCController_12states < handle
    ...
    methods
        ...
        function obj = MPCController_12states(model_obj)
            obj.model = model_obj;
            obj.cp = ControlParameters; 
            
            obj.Q = diag(obj.cp.Q_diag_12);
            obj.Qf = diag(obj.cp.Qf_diag_12);
        ...
        %
        % INPUTS:
        %   x0    - [12x1] Initial measured state
        ...
        %
        % INPUTS:
        %   x_meas   - [12x1]     Current state feedback measurement
        %   xref_seq - [12x(N+1)] Reference state trajectory over horizon
        ...
        function [u_next, debug_info] = solve(obj, x_meas, xref_seq, uref_seq)
            ...
            % State Constraints
            x_lims.min = obj.cp.x_min_12;
            x_lims.max = obj.cp.x_max_12;
